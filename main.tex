...
\renewcommand{\modelurl}{\url{https://github.com/tongshuangwu/polyjuice}}
...
\newcommand{\fixed}[1]{{\color{blue}#1}\xspace}
\renewcommand{\fixed}[1]{{#1}\xspace}
...
\newcommand{\dan}[1]{\arkcomment{\marker{D}{W}}{#1}{purple}}
...
\hspace{4mm}
\href{mailto:marcotcr@microsoft.com}{\texttt {marcotcr@microsoft.com}}
\hspace{4mm}
...
We show that \sysname produces diverse sets of realistic counterfactuals, which in turn are useful in various distinct applications: improving training and evaluation on three different tasks (with around 70\% less annotation effort than manual generation), augmenting state-of-the-art explanation techniques, and supporting systematic counterfactual error analysis by revealing behaviors easily missed by human experts.
