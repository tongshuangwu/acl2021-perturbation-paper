...
By validating diverse counterfactuals, we produced high-quality evaluation contrast sets and training data that results in higher generalization accuracy, with at least 40\% less effort.
As counterfactual explanations, \sysname helps reveal models' abnormal behaviors both locally and globally, and complements popular feature attribution methods by finding their blind spots.
\end{abstract}
