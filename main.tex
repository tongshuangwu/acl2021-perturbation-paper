...
\newcommand{\modelurl}{\url{https://huggingface.co/tongshuangwu/polyjuice}}
...
\maketitle
\begin{abstract}
Counterfactual examples are widely effective for calibrating, evaluating, and explaining model decision boundaries, yet either existing generation methods cover limited linguistic patterns or are hard to scale.
...
We propose various strategies to selection the outputs for downstream tasks, and demonstrate \sysname in different applications:
