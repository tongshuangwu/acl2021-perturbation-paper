...
\newcommand{\relation}[1]{$x\veryshortarrow#1$\xspace}
...
by generating diverse counterfactuals for humans to label, \sysname produced high-quality datasets for evaluating and improving model generalization, with at least 40\% less effort.
