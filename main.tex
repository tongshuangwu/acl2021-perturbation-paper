...
\dan{Counterfactual examples have been shown to be useful for many applications, including calibrating, evaluating, and explaining model decision boundaries. However, previous methods for generating such counterfactual examples have been tightly tailored to specific use, used  a limited range of linguistic patterns, or are hard to scale. 
