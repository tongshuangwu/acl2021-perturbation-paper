...
As counterfactual explanations, \sysname helps reveal models' erroneous behaviors both locally and globally, and complements popular feature attribution methods by finding their blind spots.
\end{abstract}
