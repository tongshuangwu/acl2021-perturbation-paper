...
While counterfactual examples (or perturbations) are useful for analysis and training of NLP models, current generation methods either rely on manual labor to create very few counterfactuals, or only instantiate a small set of automatic perturbations such as paraphrases or word substitutions.
