...
%We also compare \sysname to counterfactuals generated by RoBERTa and GPT-2, using their distance to the original instance, measured by syntactic~\cite{zhang1989simple} and word level Levenshtein edit distance~\cite{levenshtein1966binary}. , and perturbation diversity by self-BLEU~\cite{zhu2018texygen}
