...
Counterfactual explanations complement SHAP with concrete examples and surprising behaviors, \eg (C) asserts that even changing the low weight token \swap{friend}{woman} can surprisingly flip the prediction ($\neq)$.
}
\vspace{-10pt}
