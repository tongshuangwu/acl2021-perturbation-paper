...
To balance the distribution (Table~\ref{table:gpt_train_stats}), for each dataset, we extract \tagstrs from all the $(x, \xp)$, and randomly sample up to 10,000 instances per \tagstr.
...
The success rate increases by $28\% \pm 18\%$ across all \tagstrs, ranging from \ctrltag{quantifier} (increasing 8\%, from 40\% to 48\%) to \ctrltag{insert} (65\%, from 14\% to 79\%).
