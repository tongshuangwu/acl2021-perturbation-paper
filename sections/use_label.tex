\newcommand{\maug}{\texttt{polyjuice}\xspace}
\newcommand{\mcomp}{\texttt{baseline}\xspace}
\newcommand{\mcad}{\texttt{CAD}\xspace}
...
\midrule
\mcomp 	&  $85.7\pm 0.4$&  $86.1\pm 0.2$&  $86.6\pm 0.2$&  $72.8\pm 0.3$&  $86.4\pm 1.5$&  $54.5\pm 0.6$&  $65.1\pm 0.6$&  $56.0\pm 0.8$\\
 %20,000 &  1,574 &  \texttt{aug-r} &  $85.7\pm 0.4$ &  $86.1\pm 0.1$ &  $86.2\pm 0.1$ &  $73.4\pm 0.5$ &  $87.2\pm 0.6$ &  $54.7\pm 0.3$ &  $64.6\pm 0.6$ &  $56.9\pm 0.8$ \\
 
\mcad &  $85.8\pm 0.6$ &  $86.6\pm 0.1$ &  $85.6\pm 0.3$ &  $\mathbf{73.8\pm 0.2}$ &  $\mathbf{89.4\pm 2.9}$ &  $55.8\pm 0.9$ &  $65.5\pm 0.5$ &  $56.4\pm 0.4$ \\
 
 
\maug	&  $85.3\pm 0.3$&  $86.0\pm 0.1$&  $86.4\pm 0.0$&  $\mathbf{73.6\pm 0.2}$&  $\mathbf{89.1\pm 1.2}$&  $\mathbf{57.7\pm 0.3}$&  $65.1\pm 0.2$&  $\mathbf{57.5\pm 0.5}$\\
...
Compared to \mcad, the augmented model using \emph{manually} created counterfactuals from \citet{kaushik2019learning}, \maug achieves compatible (and sometimes larger) improvements on DNC~\cite{kim2019probing} (the reference for our slicing functions), as well as other \colbox{ccon}{contrast/challenge sets}~\cite{naik2018stress, glockner-etal-2018-breaking, wang2018glue}.
}
\vspace{-5pt}
\label{table:aug_nli}
\end{table*}
...
As a compensation, we use the slicing functions of \citet{chen2019slice} to find patterns of interest (\eg prepositions in \nli~\cite{kim2019probing}), and perturb those patterns by placing \texttt{[BLANK]}s on the matched spans. For example, \exinline{His surfboard is beneath him} becomes \exinline{His surfboard is \texttt{[BLANK]} him}, and \sysname generates counterfactuals such as  \exinline{His surfboard is \swap{beneath}{next to} him}.
...
Even when we apply aggressive post-hoc filtering (\eg only keeping $\xp$ that flip labels for contrast sets), and discard a fraction of $\xp$ as invalid (\eg 18\% of \nli counterfactuals) or not satisfying the desired relationship (\eg 40\% of valid \nli counterfactuals when collecting label-flipping contrast sets), we still obtain suitable $\xp$ in at most 1--2.5 minutes.
