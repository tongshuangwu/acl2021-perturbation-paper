...
The results are similar for other combinations we explored (see \tofix{Appendix~\ref{TODO}}), except when the ratio of counterfactual to original data was too high (\eg, $m=n$ may decrease vocabulary diversity or induce additional data bias, echoing~\cite{Khashabi2020MoreBF}).}
