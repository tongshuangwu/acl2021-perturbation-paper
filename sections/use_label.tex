...
\end{tabular}
\vspace{-5pt}
\caption{Counterfactuals as contrasts sets. The table contains accuracies on the development set, the original set of $x$, the contrast sets, and consistency (cases where the model predicts both $x$ and $\xp$ correctly).}
\vspace{-5pt}
