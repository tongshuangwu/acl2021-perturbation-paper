...
\vspace{-5pt}
\caption{
Sample CheckList tests for \qqp, where \maug performed better than \mcomp, with $\Delta$ fail\% denoting the failure rate difference between \maug and \mcomp (negative means \maug is better).
...
\wts{Maybe cut / appendix?}Interestingly, different datasets react differently to the $m/n$ ratio.
