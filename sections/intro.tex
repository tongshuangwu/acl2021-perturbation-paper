...
Applications of counterfactual reasoning to NLP generally specify what the $x \rightarrow \xp$ relationship is, and then ask humans to manually create counterfactuals $\xp$, or perturbation functions that generate $\xp$.
...
\begin{figure}[t]
\centering
\includegraphics[trim={0 17cm 25cm 0cm},clip, width=1\columnwidth]{figures/teaser}
\vspace{-15pt}
\caption{
Overview of \sysname. 
...
After playing with the model and inspecting SHAP weights, NLP experts simulate at least \tofix{10\%} more abnormal ones incorrectly, compared to human-generated or random counterfactuals.