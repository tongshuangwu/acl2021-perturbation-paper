...
Analysts rarely check both \swap{is}{is not} and \swap{is}{isn't}, and therefore can overlook potential differences, echoing our observation (\S\ref{subsec:exp_user_study}) that manual counterfactual analysis can be misleading.
